...
// Function to print the cube in a structured format
...
void genetic_algorithm(int cube[N][N][N], int population_size, int iterations) {
    ...
    printf("Initial Cube:\n");
    print_cube(population[best_idx].cube);
...
int main() {
    ...
    int population_size = 2000;  // Set your population size here
    int iterations = 5000;      // Set your number of iterations here
